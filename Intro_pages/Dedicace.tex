...
\vspace{-1.3cm}
\begin{spacing}{1.4}
	\lettrine[lines=3,lhang=0.1,loversize=0.15]{À}{} ceux qui m’ont accompagné de près ou de loin dans ce parcours, je souhaite adresser toute ma gratitude.
	
	\vspace{1em}
	
	\textit{À ma chère mère}, pour son amour inconditionnel, ses prières silencieuses, et sa force douce qui m’a porté jusqu’ici.
	...
	\textit{À ma grand-mère}, partie le premier jour de ce cycle universitaire — ton absence m’a pesé, mais ton empreinte m’a guidé.
