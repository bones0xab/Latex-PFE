...
\begin{itemize}
	...
	\item \textbf{Casablanca, Tétouan} : Siège social pour l’Afrique, moteur de la transformation digitale au Maroc
...
La Figure \ref{fig:secteurs-nttdata} illustre la structure organisationnelle de la filiale marocaine de NTT DATA. Bien que l'entreprise fasse partie d'un groupe mondial, elle dispose d'une organisation locale agile pour répondre aux enjeux du marché marocain et à ses objectifs de création de 1000 emplois (annoncé en 2022).
...
\begin{itemize}
    ...
    \item Développer un module d’analyse individuelle (Worker Insights) permettant d’évaluer la charge, la performance et les risques de chaque développeur via l’IA.
\end{itemize}
...
\begin{itemize}
    ...
    \item Calculer des signaux de santé projet (WIP ratio, stale ratio, overdue rate, coefficient de Gini) à partir des données historiques et en temps réel, Ces métriques sont détaillées dans le chapitre 4..
...
\begin{itemize}
	...
	\item \textbf{Scrum Master} :  Mohammed Amine Elmeknassi, supervise le processus Scrum, organise les réunions quotidiennes, répartit les tâches et identifie les blocages.
