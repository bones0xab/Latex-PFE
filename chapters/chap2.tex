...
\renewcommand{\labelitemi}{—}
    ...
    \item \textbf{Microsoft Teams} : outil de communication quotidienne pour les réunions de synchronisation (daily stand-ups) et les échanges avec l’encadrement.
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.2\linewidth]{assets/logos/teams_logo.png} % Remplacez par votre fichier ou supprimez si absent
        \caption{Logo de Microsoft Teams}
        \label{fig:teams}
    \end{figure}
    
    \item \textbf{GitLab} : plateforme de gestion de version basée sur Git, utilisée pour le suivi des modifications du code source et la collaboration entre développeurs, accessible à l’adresse \href{https://umane.emeal.nttdata.com/git/FELTRIINTPROJ/nttdata-ai-agent-project-tracking}{https://umane.emeal.nttdata.com/git/FELTRIINTPROJ/nttdata-ai-agent-project-tracking}.
    \begin{figure}[H]
        \centering
    ...
    \item \textbf{Jira} : utilisé pour le suivi des tâches du projet lui-même, accessible à l’adresse \href{https://umane.emeal.nttdata.com/jiraito/browse/HPCMOROCCO}{https://umane.emeal.nttdata.com/jiraito/browse/HPCMOROCCO}, démontrant ainsi l’adéquation de la plateforme avec les méthodes agiles.
    \begin{figure}[H]
        \centering
    ...
    \item \textbf{Postman} : outil de test d’API REST, employé pour valider les endpoints FastAPI avant intégration.
    % (Pas de logo pour Postman dans cette version)
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.2\linewidth]{assets/logos/docker_compose.jpg} % Idéalement un logo dédié
