...
\begin{figure}[H]
    ...
    \caption{Diagramme de cas d’utilisation de la plateforme IA}
    \label{fig:use_case}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Diagramme de classes – structure statique du système}
...
\begin{figure}[H]
    ...
    \caption{Extraction asynchrone des données Jira avec pagination et gestion des quotas}
...
\begin{figure}[H]
    ...
    \caption{Orchestration LangGraph du pipeline IA (règles, Mistral, cache, snapshot)}
...
\begin{figure}[H]
    ...
    \caption{Authentification JWT et contrôle d’accès basé sur les rôles}
    \label{fig:seq_rbac}
\end{figure}
